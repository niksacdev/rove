...
class TestComputeDynamics:
    ...
    def test_compute_dynamics_basic(self, panda_urdf):
        ...
        assert summary["torque_feasible"] is None
        assert summary["gravity_feasible"] is None
        ...
        assert {e["field"] for e in result["not_computed"]} >= {"torque_feasible", "gravity_feasible"}
    ...
    def test_compute_dynamics_empty_actions(self, panda_urdf):
        ...
        assert summary["torque_feasible"] is None
        assert summary["gravity_feasible"] is None
        assert summary["near_singularity"] is None
