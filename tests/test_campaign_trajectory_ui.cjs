...
test("timeline distinguishes changed cases/scoring and current outcomes from frozen baseline evidence", t=>{
  ...
  assert.match(view.textContent,/Cases changedScoring changed/);assert.match(view.textContent,/No improvement claim/);assert.match(view.textContent,/current assessments as of/);assert.match(view.textContent,/1 not scored/);
  ...
  render(view,data);assert.match(view.textContent,/Frozen baseline revision frozen-r1/);assert.match(view.textContent,/Frozen reference: 0 passed · 1 failed · 1 not scored/);assert.match(view.textContent,/1 unresolved pairs/);
